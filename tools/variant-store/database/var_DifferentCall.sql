drop function if exists var_DifferentCall;

create function var_DifferentCall(_primary varchar(10), _secondary varchar(10), _chrom varchar(20), _startpos bigint, _endpos bigint)
returns table (
    seq_id varchar(20),
    pos bigint,
    rs text,
