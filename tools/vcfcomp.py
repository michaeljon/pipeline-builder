...
def compare(left, right):
    ...
    left_dummy = {**dummy, "CHROM": next(iter(left.values()))["CHROM"]}
    right_dummy = {**dummy, "CHROM": next(iter(right.values()))["CHROM"]}
    ...
    print("{}\t{}\t{}\t{}\t\t{}\t{}\t{}\t{}".format("CHROM   ", "POS", "REF", "ALT", "CHROM   ", "POS", "REF", "ALT"))
